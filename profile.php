  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p>This will appear on the iser's profile page and also their newsfeed for your friends to see</p>
	...
	$(document).ready(function() {
		...
		$.ajax({
			url: "includes/handlers/ajax_load_profile_posts.php",  //call this function
			type: "POST",
			data: "page=1&userLoggedIn=" + userLoggedIn + "&profileUsername=" + profileUsername,  // sent as a data. Request: userLoggedIn
			cache:false,
		...
		$(window).scroll(function() {  
			...
			if (($(window).scrollTop() + $(window).height() == $(document).height()) && noMorePosts == 'false') {
				...
				var ajaxReq = $.ajax({ //infinite scrolling
