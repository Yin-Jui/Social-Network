...
$query = $_POST['query']; //retrieve data from Social.js 94
$userLoggedIn = $_POST['userLoggedIn'];
$names = explode(" ", $query);
//ex. Jimmy Liao -> names[0] = Jimmy, names[1] = Liao

//If query contains an underscore, assome user is searching for usernames

if(strpos($query, '_') !== false) //triple equal === also test if the type is equal.
