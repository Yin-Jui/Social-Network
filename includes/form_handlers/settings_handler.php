...
if(isset($_POST['update_password'])) { //Update password button is clicked.

	$old_password = strip_tags($_POST['old_password']);  //strip html and php tags from a string.
...
if(isset($_POST['close_account'])) {  //close account button is clicked.
